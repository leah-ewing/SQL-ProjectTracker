...
COPY public.grades (id, student_github, project_name, grade) FROM stdin;
1	jhacks	Markov	10
2	jhacks	Blockly	2
...
3	Fresh Made Easy	Doordash for CSA	1000
4	Music Mood Journal	Song of the Day	100
5	Bookshelf	Book reading tracker	100
\.
